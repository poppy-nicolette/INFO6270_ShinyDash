...
A dashboard is one that uses data that has been placed on the server, (or you have uploaded) or streams real-time and shows a variety of graphs, charts, and tables. In this case, we use data from OpenAlex and we perform simple calculations on the results.
...
2.  Download the following file from [github](https://raw.githubusercontent.com/poppy-nicolette/INFO6270_ShinyDash/main/FirstAppDemo/FirstAppDemo.R?token=GHSAT0AAAAAABUWXK4ASXIXEO55MQKBPVKOY7XTYUQ) and `Save Page As...` from your browser to this directory. Then rename the file from *FirstAppDemo.txt* to *FirstAppDemo.R*
...
1.  Create a shinyapps.io account. You will need this [login](https://www.shinyapps.io/admin/#/signup) info to set up your RStudio to publish directly to shinyapps.io. I recommend connecting via your GitHub account, if you have one. Otherwise, just start a new account.
...
At this point, you know enough to open existing apps on Shiny Gallery, modify their open code, and publish them on shinyapps.io. In chapter 11b, we'll be going over many of the inputs and outputs with an exercise that will help you design apps based on your needs.
...
The next section of chapter 11 moves into a more detailed view of the inputs and outputs. Chapter 12 will show you how to make shiny apps shine with layouts and interactivity.
