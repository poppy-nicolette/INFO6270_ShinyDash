...
DataTables are more appropriate for larger dataframes where someone may need to explore, filter, and sort data.

There are two libraries that make DataTables amazing. One is reactable and the other is DT. Both are great but reactable is much easier to use and integrate with Shiny and even Quarto.

[![](images/reactable.png){fig-align="left" width="100"}](https://glin.github.io/reactable/index.html)
