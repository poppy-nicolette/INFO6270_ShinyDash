...
file uploads and downloads are more complicated types of inputs and outputs. There is a special chapter dedicated to them on the Mastering Shiny webbook [here](https://mastering-shiny.org/action-transfer.html).
...
Outputs are assigned in the UI to define spaces where outputs will be seen. The include a unique ID in the first position of its arguments.
