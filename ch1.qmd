...
The UI and the server both have inputs and outputs that will be assigned and called. We'll go over those in the Widgets section later on.
...
You can find all of these in the input section in the shiny references documentation [here.](https://shiny.rstudio.com/reference/shiny/1.7.4/) The following selection are some of the more commonly used ones to get you started.
...
This one is better for longer sections of text, like bio's for websites, brief passages, comments, special instructions, etc. You can find more info [here](https://shiny.rstudio.com/reference/shiny/1.7.4/textareainput) on its arguments.
    ...
    ui <- fluidPage(
      textInput("breakfast", "What's your favorite breakfast?"),
      passwordInput("password", "Please enter your password"),
      textAreaInput("bio", "Please tell us about yourself in 75 words or less.", rows = 3)
    )
...
Bootstrap themes control the styling of the application, unifying colors and fonts, for example. Themes are assigned in the UI. You can find Bootstrap themes here.
...
It is possible to create your own themes, use themes other than Bootstrap, or modify Bootstrap themes to your own aesthetic needs. *Mastering Shiny* has a brief chapter on themes [here,](https://mastering-shiny.org/action-layout.html) and you can also find more information here on Bootstrap themes. [Here is a link](https://www.w3schools.com/colors/default.asp) for the hex codes or names you'll need for colors.
...
In this chapter, we've covered what shiny is, how to get started, and dived into some of the most common elements used for applications. You now know how to publish your own content with Shiny!
...
The next chapter moves into a more detailed view of how to make shiny apps shine with interactivity and reactiveness. In other words, we'll learn how to upload data, apply code to analyze it, interact with dynamic tables and visualizations, and then download results.
